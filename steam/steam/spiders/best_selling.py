...
class BestSellingSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for game in games:
            ...
            loader.add_xpath('release_date', ".//div[@class='col search_released responsive_secondrow']/text()")
            loader.add_xpath('platform', ".//span[contains(@class,'platform_img') or @class='vr_required' or @class='vr_supported']/@class")
        ...
        nxt_pg = response.xpath(".//a[@class='pagebtn' and text() ='>']/@href").get()
        print(nxt_pg)
        if nxt_pg:
